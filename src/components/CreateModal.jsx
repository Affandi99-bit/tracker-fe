...
const CreateModal = ({
  ...
  return (
    showModal && (
      <div>
        <main
          className="fixed overflow-y-auto z-20 top-0 text-dark"
          onClick={handleBackdropClick}
        >
          <section className="relative overflow-auto w-screen h-screen no-scrollbar bg-light ">
                  ...
                  <div className="flex flex-col gap-1 w-full">
                    ...
                    <label className="sf font-semibold tracking-widest flex flex-col">
                      ...
                      <input
                        ...
                        className="border border-dark font-light rounded p-2 sf tracking-widest outline-none"
                      />
                    </label>
                    <div className="flex gap-1">
                      ...
                      <label className="sf font-semibold tracking-widest flex flex-col">
                        ...
                        <input
                          ...
                          onChange={inputHandle}
                          className="border border-dark font-light rounded p-2 sf tracking-widest outline-none mb-1 lg:mb-0"
                        />
                      </label>
                      {/* PIC */}
                      <label className="sf font-semibold tracking-widest flex flex-col">
                    ...
                    <section className="flex gap-1 items-center w-full">
                      ...
                      <label className="sf font-semibold tracking-widest">
                        ...
                        <input
                          ...
                          onChange={inputHandle}
                          className="border border-dark font-light rounded p-2 h-full w-full sf tracking-widest outline-none mb-1 lg:mb-0"
                        />
                      </label>
                      {/* Final File */}
                      <label className="sf font-semibold tracking-widest">
                    ...
                    <textarea
                      ...
                      value={formData.note}
                      onChange={inputHandle}
                      className="border border-dark font-light rounded p-2 h-40 sf w-full tracking-widest outline-none"
                    />
                  </div>
                </section>
                <section className="flex gap-1 w-1/2">
                  {/* Progress */}
                  <div className="border border-dark font-light rounded p-2 ">
                    ...
                    {tags.progress.map((option) => (
                      ...
                      >
                        ...
                        <div
                          htmlFor={`hr-${option.value}`}
                          className="size-5 flex rounded border-dark border border-dark-[#a2a1a833] bg-dark peer-checked:bg-light transition"
                        >
                          <svg
                            fill="none"
                            viewBox="0 0 24 24"
                  ...
                  <asides className="flex flex-col gap-1">
                    {/* Categories */}
                    <div className="border border-dark font-light rounded p-2 ">
                      ...
                      {tags.projectCategories.map((option) => (
                        <label
                          htmlFor={`hr-${option.value}`}
                          key={option.value}
                          className={`flex flex-row w-32 items-center gap-2 sf tracking-widest cursor-pointer `}
                        >
                          <input
                            id={`hr-${option.value}`}
                            type="checkbox"
                          ...
                          <div
                            htmlFor={`hr-${option.value}`}
                            className="size-5 flex border-dark rounded border border-dark-[#a2a1a833] bg-dark peer-checked:bg-light transition"
                          >
                            <svg
                              fill="none"
                              viewBox="0 0 24 24"
                        ...
                        {crew.map((option, index) => (
                          ...
                          >
                            <input
                              ...
                              className="peer hidden"
                            />
                            <div className="size-5 flex rounded border border-dark border-dark-[#a2a1a833] bg-dark peer-checked:bg-light transition">
                              <svg
                                fill="none"
                                viewBox="0 0 24 24"
                                className="size-5 stroke-dark"
                          ...
                          {additionalCrewMembers.map((member) => (
                            ...
                            >
                              <input
                                ...
                                className=" border border-dark-gray-400 outline-none p-1 w-[80%]"
                              />
                              <button
                                type="button"
                                className="text-lg"
              ...
              <div className="flex justify-between gap-1">
                {isEditing && (
                  <button
                    ...
                    className=" flex border-dashed border border-dark items-center justify-center gap-1 sf tracking-widest rounded py-2 w-56 font-semibold transition ease-in-out hover:scale-105 duration-300 active:scale-95"
                  >
                    Delete
                    {isLoadingDelete && (
                      <svg
