                ...
                return (
                    <main className='font-body text-light flex flex-col lg:flex-row w-full justify-start lg:items-start relative' key={i}>
                        ...
                        <section className="flex flex-col p-2 w-full lg:w-1/2">
                            <nav>
                                ...
                                <div className="w-full rounded-full h-2.5 bg-gray-700/25">
                                    <div
                                        ...
                                        style={{
                                            width: `${
                                                Array.isArray(pro.kanban?.[0]?.steps) && pro.kanban[0].steps.length > 0
                                                    ? Math.round(
                                                        pro.kanban[0].steps.reduce(
                                                            (acc, step) =>
                                                                acc +
                            ...
                            {/* Kanban Steps */}
                            {Array.isArray(pro.kanban?.[0]?.steps) && pro.kanban[0].steps.length > 0 ? (
                                pro.kanban[0].steps.map((step, stepIdx) => (
                                    <section key={stepIdx}>
                                        <div
                                ...
                                <div className="text-gray-400 text-xs mt-4">No progress data available.</div>
                            )}
                        </section>
                    </main>
                );
